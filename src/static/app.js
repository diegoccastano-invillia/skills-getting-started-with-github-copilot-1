                    ...
                    .map(
                      (participant) => `
                        <li>
                          ...
                          <button class="delete-participant" type="button" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" aria-label="Unregister ${participant}">&#128465;</button>
                        </li>`
                    )
                    .join("")
